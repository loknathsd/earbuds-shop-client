    ...
    return (
        <div className='container mx-auto flex gap-10 mt-8'>
            ...
            <div id='info-area' className='w-[60%] text-[#324d67]'>
                ...
                <div id='quantity' className='flex gap-8'>
                    <h2 className='text-lg font-bold'>Quantity :</h2>
                    <div className='inline-flex rounded-md shadow-sm'>
                        <button className='px-5 py-2 text-lg font-medium text-gray-900 bg-gray-200 border border-gray-200 rounded-l-lg '>-</button>
                        <button className='px-5 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200'>1</button>
                        <button className="px-5 py-2 text-lg font-medium text-gray-900 bg-gray-200 border border-gray-200 rounded-r-md">+</button>
                    </div>
                </div>
                <div id="addBuy">

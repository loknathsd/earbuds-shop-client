...
const AddProduct = () => {
    ...
    return (
        <div style={{fontFamily:"rokkitt"}} className='lg:w-[100%] shadow-lg bg-gray-100 rounded-lg p-12 lg:mx-[20%] mt-5 md:mx-10 max-sm:mx-6 text-center  '>
            <h1 className='text-center text-xl font-semibold mb-8 '>{id ? "Update" : "Add"} Product</h1>
